package com.cj.assignment.client.dto;

import com.cj.assignment.client.domain.Client;
...
public class ClientFindResponse {
    ...
    @ApiModelProperty(example = "김아무개", value = "고객 이름")
    private String name;
    ...
    @ApiModelProperty(example = "01000000000", value = "고객 연락처")
